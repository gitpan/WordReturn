# This Makefile is for the Text::WordReturn extension to perl.
#
...
#	NAME => q[Text::WordReturn]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[WordReturn.pm]
...
DISTNAME = Text-WordReturn
NAME_SYM = Text_WordReturn
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
FULLEXT = Text/WordReturn
BASEEXT = WordReturn
PARENT_NAME = Text
DLBASE = $(BASEEXT)
VERSION_FROM = WordReturn.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = WordReturn.pm

PM_TO_BLIB = WordReturn.pm \
	$(INST_LIBDIR)/WordReturn.pm
...
manifypods : pure_all WordReturn.pm
	@$(POD2MAN) \
	WordReturn.pm \
	$(INST_MAN3DIR)/Text::WordReturn.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/WordReturn.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Text-WordReturn\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Text-WordReturn</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Text-WordReturn.ppd
