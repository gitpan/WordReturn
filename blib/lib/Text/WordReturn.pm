...
#########################################################
# getWebPage						#
# the sub-routine to get the text of a WWW page using	#
# LWP::Simple						#
#########################################################
...
B<tag> - words appearing between these specified tags will get a higher value (1.2).
